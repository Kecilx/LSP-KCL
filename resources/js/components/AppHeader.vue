...
import { BookOpen, Folder, LayoutGrid, Menu, Search, ShoppingCart, Store, FileText } from 'lucide-vue-next';
...
// Memberikan tipe data 'any' agar TypeScript tidak mendeteksi 'auth' sebagai 'unknown'
...
const mainNavItems: NavItem[] = [
    ...
    // Menu Master Kategori ditambahkan di sini
    {
